<<<<<<< HEAD:src/components/IncomePartition/oldSystem/PartitionTree.tsx
...
export default PartitionTree;
>>>>>>> parent of 8e04ecc (Fix visual and loading bug):src/components/IncomePartition/PartitionTree.tsx
