<<<<<<< HEAD:src/components/IncomePartition/oldSystem/IncomePartition.tsx
...
export default IncomePartition;
>>>>>>> parent of 8e04ecc (Fix visual and loading bug):src/components/IncomePartition/IncomePartition.tsx
